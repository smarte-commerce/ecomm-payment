 ...
 * Handles payment processing, refunds, and payment method management with
 * providers like Stripe, PayPal, Square, etc.
 */
...
public interface PaymentGatewayServiceClient {
  ...
  RestResponse<GatewayPaymentMethodResponse> detachPaymentMethod(
      @PathVariable("paymentMethodId") String paymentMethodId);
  ...
  RestResponse<GatewayInvoiceListResponse> getSubscriptionInvoices(
      @PathVariable("subscriptionId") String subscriptionId);
  ...
  class CheckoutSessionRequest {
    ...
    private String vnp_Locale; // Language: vn, en
    private String vnp_OrderType; // Order type for VNPay
    private String vnp_IpAddr; // Customer IP address

    // Momo specific fields
    private String partnerCode;
    private String requestType; // captureWallet, payWithATM
    private String notifyUrl; // IPN URL for Momo
    private String extraData; // Additional data for Momo
    private String autoCapture; // true/false for auto capture

    // QR Code support
    private String qrCode; // Generate QR code if supported
    private String appScheme; // Deep link scheme for mobile apps
  ...
  class CheckoutSessionResponse {
    ...
    private String qrCodeUrl; // QR code URL for VNPay/Momo
    private String qrCodeData; // QR code data string
    private String deeplink; // Mobile app deeplink for Momo
    private String transactionId; // Provider transaction ID
    private String paymentCode; // Provider payment code
    private String signature; // Response signature for verification
    ...
    // Provider-specific getters/setters
