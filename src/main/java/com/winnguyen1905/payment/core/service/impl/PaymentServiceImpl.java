...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentResponse createPayment(PaymentRequest request) {
        ...
        if (request.getProviderId() != null) {
            provider = paymentProviderRepository.findById(request.getProviderId())
                    .orElseThrow(() -> new ResourceNotFoundException("Payment provider not found with ID: " + request.getProviderId()));
        }
    ...
    private PaymentResponse mapToResponse(EPayment payment) {
        return PaymentResponse.builder()
                ...
                .paymentMethodDisplayName(payment.getPaymentMethod() != null ? payment.getPaymentMethod().getDisplayName() : null)
