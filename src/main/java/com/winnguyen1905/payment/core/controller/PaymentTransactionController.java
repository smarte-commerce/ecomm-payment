...
public class PaymentTransactionController {
  ...
  public ResponseEntity<PaymentTransactionResponse> getPaymentTransactionByTransactionId(
  ...
  public ResponseEntity<List<PaymentTransactionResponse>> getPaymentTransactionsByCustomerId(
      @PathVariable Long customerId) {
    List<PaymentTransactionResponse> response = paymentTransactionService
        .getPaymentTransactionsByCustomerId(customerId);
    return ResponseEntity.ok(response);
  }

  @GetMapping("/vendor/{vendorId}")
  public ResponseEntity<List<PaymentTransactionResponse>> getPaymentTransactionsByVendorId(
