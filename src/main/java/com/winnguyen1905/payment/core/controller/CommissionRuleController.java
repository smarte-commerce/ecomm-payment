...
public class CommissionRuleController {
  ...
  @PostMapping
  public ResponseEntity<CommissionRuleResponse> createCommissionRule(
  ...
  public ResponseEntity<List<CommissionRuleResponse>> getCommissionRulesByVendorAndCategory(
    ...
    List<CommissionRuleResponse> response = commissionRuleService.getCommissionRulesByVendorAndCategory(vendorId,
        categoryId);
    return ResponseEntity.ok(response);
  }
  ...
  public ResponseEntity<CommissionRuleResponse> getBestApplicableCommissionRule(
      ...
      @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime effectiveDate) {
    CommissionRuleResponse response = commissionRuleService.getBestApplicableCommissionRule(vendorId, categoryId,
        orderAmount, effectiveDate);
    return ResponseEntity.ok(response);
  }
  ...
  public ResponseEntity<Boolean> checkConflictingRules(
    ...
    boolean hasConflicts = commissionRuleService.hasConflictingRules(vendorId, categoryId, effectiveDate,
        expirationDate, excludeRuleId);
