...
public class PaymentWebhookController {
  ...
  @PostMapping
  public ResponseEntity<PaymentWebhookResponse> createPaymentWebhook(
  ...
  public ResponseEntity<List<PaymentWebhookResponse>> getPaymentWebhooksBySubscriptionId(
  ...
  public ResponseEntity<List<PaymentWebhookResponse>> getPaymentWebhooksByWebhookType(
